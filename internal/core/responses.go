...
// can round-trip extensions; typed fields should be preferred when available.
type ResponsesRequest struct {
	...
	ExtraFields          UnknownJSONFields         `json:"-"`
}
...
// extensions can round-trip; typed fields should be preferred when available.
