...
type ModelsConfig struct {
	...
	// DisableReasoning lists concrete model selectors whose translated requests
	// must have reasoning controls stripped before forwarding.
	DisableReasoning []string `yaml:"disable_reasoning" env:"DISABLE_REASONING_MODELS"`
}
