...
// binaries on top of thinroute. External modules register request rewriters,
...
type Result struct {
	...
	// can annotate what they did (for example X-thinroute-Pro-Tokens-Saved).
	...
	// the input cost those tokens would have incurred, and the admin API
